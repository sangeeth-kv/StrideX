    ...
    verifyCOD: async (req, res) => {
        try {
            ...
            for (const item of cart.items) {
                ...
                console.log("Item Price : ", itemPrice, "Product Offer : ", product.offer, "Category Offer : ", product.categoryId.offer);
                ...
                console.log(`Sale Price for ${product.name} (${item.size}): ₹${itemSalePrice}`);
    ...
    loadOrderDetailsPage:async (req,res) => {
        try {
            ...
            order.items = order.items.map(item => {
                ...
                console.log("Category Offer:", categoryOffer, "Product Offer:", productOffer, "Max Offer:", maxOffer);
                ...
                console.log(`Product: ${product.name}, Regular Price: ${regularPrice}, Sale Price: ${salePrice}, Max Offer: ${maxOffer}`);
        ...
        try {
            ...
            order.items[itemIndex].itemStatus = "cancelled";
                ...
                await productSchema.updateOne(
                    ...
                    const retProduct=await productSchema.findOne({ _id: product.productId, "variants.size": product.size }).populate("categoryId")
            ...
            const allCancelled = order.items.every(item => item.itemStatus === "cancelled" || item.itemStatus === "returned");
            if (allCancelled) {
            ...
            await wallet.save();
            console.log("Refund processed successfully in cancel individual item  >>!");
            }
